...
class KafkaStreamsSetup<K, V>(
	topology: Topology,
	private val keySerde: Serdes.WrapperSerde<K>,
	private val valueSerde: Serdes.WrapperSerde<V>
) {
	...
	private fun kafkaConfig() = Properties().also {
		...
		it[StreamsConfig.DEFAULT_KEY_SERDE_CLASS_CONFIG] = keySerde::class.java
		it[StreamsConfig.DEFAULT_VALUE_SERDE_CLASS_CONFIG] = valueSerde::class.java
